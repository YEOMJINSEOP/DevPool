    ...
    <div className={styles.teamMemberContainer}>
      <div className={styles.teamMemberStatus}>
        ...
        <ul className={styles.teamMemberList}>
          ...
          <li>
            <div> <span>{member.memberId === team.hostMember.memberId ? '👑 팀장' : '👨🏻‍💻'}</span> {member.nickName} <button className={styles.chatBtn} onClick={() => navigate(`/user/info/${member.memberId}`)}>연락하기</button></div>
          </li>
          )}     
        </ul>
      </div>      
