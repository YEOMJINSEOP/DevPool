    ...
    <div className={styles.teamFormContainer}>
      <div className={styles.teamForm}>
        <div className={`${styles.container}`}>
          <div className={styles.label} htmlFor='name'>팀 이름</div>
        ...
        <div className={styles.categoryAndCount_container}>
          <div className={`${styles.container} ${styles.category}`}>
            <div className={styles.label}htmlFor='category'>카테고리</div>
        ...
        <div className={`${styles.container}`}>
          <div className={styles.label} htmlFor="recruitField">모집 분야</div>
        ...
        <div className={`${styles.container}`}>
          <div className={styles.label}htmlFor="stack-search">모집 스택</div>
        ...
        <div className={`${styles.container} ${styles.content}`}>
          <div className={styles.label}htmlFor="stack-search">팀 소개</div>          
