  ...
  return (
    <div>
      ...
      <div className={styles.categoryContainer}>
        <div className={styles.categoryBox} onClick={() => setSelectedCategory('web')}>
          <img className={styles.categoryLogo} src="/image/internet.png" alt="Web" />
          <p>WEB</p>
        </div>
        <div className={styles.categoryBox} onClick={() => setSelectedCategory('mobile')}>
          <img className={styles.categoryLogo} src="/image/mobile-app.png" alt="Mobile App" />
          <p>MOBILE APP</p>
        </div>
        <div className={styles.categoryBox} onClick={() => setSelectedCategory('ai')}>
          <img className={styles.categoryLogo} src="/image/ai.png" alt="AI" />
          <p>AI</p>
        </div>
        <div className={styles.categoryBox} onClick={() => setSelectedCategory('bigdata')}>
