      ...
      <div className={styles.teamForm}>
        ...
        <div className={styles.categoryAndCount_container}>
          <div className={`${styles.container} ${styles.category}`}>
            <label className={styles.title}htmlFor='category'>카테고리</label>
        ...
        <div className={`${styles.container}`}>
          <label className={styles.title}htmlFor="stack-search">모집 스택</label>
        ...
        <div className={`${styles.container} ${styles.content}`}>
          <label className={styles.title}htmlFor="stack-search">팀 소개</label>          
