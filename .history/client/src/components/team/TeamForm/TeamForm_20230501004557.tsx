...
function TeamForm(){
  ...
  const handleSelectedTechStack = (event: React.MouseEvent<HTMLImageElement>): void => {
    ...
    handleCSSToggle('Front-end');
  }
  
  const handleCSSToggle = (stack: string) => {
    selectedTechStack[stack] ? console.log(true) : console.log(false);
  }
        ...
        <div className={`${styles.container}`}>
          ...
          <div className={styles.recruitFieldList}>
            <div className={styles.recruitField}>
              <img className={styles.recruitFieldIcon} src="/image/javaScript.png" alt="Front-end" onClick={handleSelectedTechStack} />
              <p>Front-end</p>
            </div>
            <div className={styles.recruitField}>
