      ...
      <div className={styles.teamForm}>
        ...
        <div className={`${styles.container}`}>
          ...
          <div className={styles.recruitFieldList}>
            ...
            <div className={styles.recruitField}>
              <img className={styles.recruitFieldIcon}src="/image/server.png" alt="Back-end" />
              <p>Back-end</p>
            </div>
            <div className={styles.recruitField}>
              <img className={styles.recruitFieldIcon}src="/image/android.png" alt="Android" />
              <p>Android</p>
            </div>
            <div className={styles.recruitField}>
              <img className={styles.recruitFieldIcon}src="/image/apple-logo.png" alt="iOS" />
              <p>iOS</p>
            </div>
            <div className={styles.recruitField}>
            <img className={styles.recruitFieldIcon}src="/image/deep-learning.png" alt="AI" />
              <p>AI</p>
            </div>
          </div>
        </div>
