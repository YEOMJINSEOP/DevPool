...
function TeamForm(){
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLButtonElement>) => {
  ...
  return (
    <form className='team_form' action="/post할URL" method="post">
      ...
      <div className='recruit_stack'>
        ...
        <input type="text" id='stack_search_input'/>
        <button type="button" onClick={handleInputChange}>추가</button>
